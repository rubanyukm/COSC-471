...
<body>
	<table align="center" style="border:2px solid blue;">
		<tr>
			<form action="manage_bookstorecatalog.html" method="post" id="catalog">
			<td align="center">
		...
		<tr>
			<form action="reports.html" method="post" id="reports">
			<td align="center">
		...
		<tr>
			<form action="update_adminprofile.html" method="post" id="update">
			<td align="center">
		...
		<tr>
			<form action="index.html" method="post" id="exit">
			<td align="center">
