...
<body>
	...
	<tr><td><form action="" method="post">
		...
		<input type="radio" name="group1" value="user_login.html" onclick="document.location.href='user_login.html'">Returning Customer<br/>
		<input type="radio" name="group1" value="admin_login.html" onclick="document.location.href='admin_login.php'">Administrator<br/>
